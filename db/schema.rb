...
ActiveRecord::Schema[7.0].define(version: 2023_06_12_102319) do
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.index ["reel_id"], name: "index_templates_on_reel_id"
  end
  ...
  add_foreign_key "templates", "reels"
end
